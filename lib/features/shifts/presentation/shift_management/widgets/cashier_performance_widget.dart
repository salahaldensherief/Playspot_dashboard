          ...
          SingleChildScrollView(
            ...
            child: DataTable(
              ...
              columns: [
                ...
                DataColumn(label: Text('عدد الورديات', style: const TextStyle(fontWeight: FontWeight.bold, color: Colors.white))),
                DataColumn(label: Text('المغلقة', style: const TextStyle(fontWeight: FontWeight.bold, color: Colors.white))),
                DataColumn(label: Text('المعتمدة', style: const TextStyle(fontWeight: FontWeight.bold, color: Colors.white))),
                DataColumn(label: Text('إجمالي المبيعات', style: const TextStyle(fontWeight: FontWeight.bold, color: Colors.white))),
                DataColumn(label: Text('المبيعات النقدية', style: const TextStyle(fontWeight: FontWeight.bold, color: Colors.white))),
                DataColumn(label: Text('المبيعات الرقمية', style: const TextStyle(fontWeight: FontWeight.bold, color: Colors.white))),
                DataColumn(label: Text('المصروفات', style: const TextStyle(fontWeight: FontWeight.bold, color: Colors.white))),
                DataColumn(label: Text('إجمالي العجز/الزيادة', style: const TextStyle(fontWeight: FontWeight.bold, color: Colors.white))),
